...
- [/blog/design-thinking-and-its-role-in-digital-product-success](pages/blog-design-thinking-and-its-role-in-digital-product-success.html)
- [/blog/the-purpose-of-purposeful-branding-in-a-start-up-business](pages/blog-the-purpose-of-purposeful-branding-in-a-start-up-business.html)
- [/blog/the-role-of-consistency-in-visual-identity](pages/blog-the-role-of-consistency-in-visual-identity.html)
- [/blog/why-mobile-first-design-should-be-your-default-strategy](pages/blog-why-mobile-first-design-should-be-your-default-strategy.html)
- [/blog/why-your-business-needs-strategic-storytelling](pages/blog-why-your-business-needs-strategic-storytelling.html)
- [/changelog](pages/changelog.html)
- [/contact-us](pages/contact-us.html)
- [/home-v2](pages/home-v2.html)
- [/pricing](pages/pricing.html)
- [/privacy/privacy](pages/privacy-privacy.html)
- [/projects](pages/projects.html)
- [/projects/aurora-home](pages/projects-aurora-home.html)
- [/projects/bright-future](pages/projects-bright-future.html)
- [/projects/city-pulse](pages/projects-city-pulse.html)
- [/projects/elevate](pages/projects-elevate.html)
- [/projects/nordic-tones](pages/projects-nordic-tones.html)
- [/projects/studio-edge](pages/projects-studio-edge.html)
- [/services](pages/services.html)
- [/services/brand-strategy](pages/services-brand-strategy.html)
- [/services/content-systems](pages/services-content-systems.html)
- [/services/visual-identity](pages/services-visual-identity.html)
- [/services/website-design](pages/services-website-design.html)
...
| 의미 | 원본 값 | 원본 CSS 변수 |
|---|---|---|
| accent | `#ff5d17` | `--token-b5b5af65-7426-4ae2-8adc-eeccea1f8ffa` |
| ink | `#0a0a0a` | `--token-30464268-c3e9-44d0-948d-f6fdbc58a10b` |
| white | `#fff` | `--token-4b62672a-1254-4f4c-98ad-c16665e051d8` |
| white-40 | `#f9f9f966` | `--token-f0f00c30-b2ae-4d0e-a461-32c717ebf2eb` |
| secondary-orange | `orange` | `--token-6b4bf473-c2f6-44ee-882a-d7ba294744f2` |
| white-60 | `#f9f9f999` | `--token-7bec9bc7-b4c9-4bfb-b0fd-d7d7bab13a9a` |
| surface | `#f8f7f5` | `--token-2d14e1e1-d243-4c70-9b23-c973e4153738` |
| ink-30 | `#0a0a0a4d` | `--token-30640121-dae8-4c00-92a8-507d465a497c` |
...
|---|---|---|---|---|
| navigation | `30px 20px 20px` | `10px` | `0px` | relative / visible |
| primary | `4px 56px 4px 20px` | `10px` | `50px` | relative / hidden |
| hero | `80px 0px` | `10px` | `0px` | relative / hidden |
| hero-services | `0px` | `20px` | `0px` | relative / visible |
| about-us | `80px 0px 0px` | `10px` | `0px` | relative / visible |
| logos | `80px 0px` | `10px` | `0px` | relative / visible |
| projects | `0px` | `10px` | `0px` | relative / hidden |
| project-container | `0px` | `16px` | `0px` | relative / hidden |
| project-container-1dtea52 | `0px` | `16px` | `0px` | relative / hidden |
| service | `0px` | `10px` | `0px` | relative / hidden |
| key-stats | `0px` | `10px` | `0px` | relative / visible |
| feedbacks | `0px` | `10px` | `0px` | relative / hidden |
| faq | `0px` | `10px` | `0px` | relative / hidden |
| blog | `0px` | `10px` | `0px` | relative / visible |
| footer | `0px` | `10px` | `16px 16px 0px 0px` | relative / hidden |
...
|---|---|---:|---|
| `navigation` | Desktop | 46 | `pages/home.html` |
| `primary` | Primary | 53 | `pages/home.html` |
| `hero` | Hero | 3 | `pages/home.html` |
| `hero-services` | Hero services | 1 | `pages/home.html` |
| `about-us` | About us | 2 | `pages/home.html` |
| `logos` | Logos | 2 | `pages/home.html` |
| `projects` | Projects | 2 | `pages/home.html` |
| `project-container` | Project container | 2 | `pages/home.html` |
| `project-container-1dtea52` | Project container | 2 | `pages/home.html` |
| `service` | Service | 2 | `pages/home.html` |
| `key-stats` | Key stats | 2 | `pages/home.html` |
| `feedbacks` | Feedbacks | 2 | `pages/home.html` |
| `faq` | FAQ | 2 | `pages/home.html` |
| `blog` | Blog | 2 | `pages/home.html` |
| `footer` | Desktop | 70 | `pages/home.html` |
