...
const pages=new Map();
for(const page of [{id:'homepage',title:'Apple homepage',url:'https://www.apple.com/',rawDom:'/apple_design/app/dist/client/research/pages/homepage/raw.html'},...manifest.pages,...runtime.pages]){
