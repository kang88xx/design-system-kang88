export const RUNTIME_URL = "/apple_design/app/dist/client/research/runtime-motion.json";
export const CATALOG_URL = "/apple_design/app/dist/client/research/motion-catalog.json";
