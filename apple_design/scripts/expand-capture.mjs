...
const chromePath = '/home/kang/.cache/ms-playwright/chromium-1223/chrome-linux64/chrome';
...
function webPath(absPath) {
  return '/research/' + path.relative(publicRoot, absPath).replaceAll(path.sep, '/');
}
