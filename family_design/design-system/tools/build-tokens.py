#!/usr/bin/env python3
"""Build scoped Family design-system CSS variables from tokens.json."""
...
def build_css(data: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "/* Framework-neutral Family Design System variables. Scope: .fds only. */",
            ".fds {",
            declarations(source_items + light_items + base_items),
            "}",
            "",
            '.fds[data-fds-theme="dark"] {',
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Build or check Family Design System tokens.css.")
